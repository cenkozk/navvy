                ...
                >
                  {(provided) => (
                    <li
                      ...
                      ref={provided.innerRef}
                      className="p-4 md:w-80 w-auto bg-white shadow-md rounded-lg mb-4"
                      key={item.id}
...
function Links() {
  ...
  return (
    <div className="z-30">
      <div class="sm:max-w-xl flex flex-col justify-between max-w-screen-md md:h-[40rem] w-auto p-12 bg-white rounded-xl z-10 shadow-xl mt-6 m-6 overflow-auto">
        <div>
          <img
          ...
          <div className="relative flex flex-col bg-white shadow-md rounded-lg mb-4 mx-auto mt-4">
            <button
          ...
          <div className="flex flex-col items-center justify-center w-full">
            {selectedItems.length == 0 ? (
              <div class="text-center">
                <svg
                  class="w-24 h-24 mr-20 text-green-500"
                  viewBox="0 0 162 119"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
